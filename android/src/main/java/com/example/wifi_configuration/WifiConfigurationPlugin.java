...
*/
    ...
    public static boolean isWifiConnected(final String wifiSsid) {
        ...
        Log.e("Wifi ID", wifiSsid + "   " + wifiConnected);
    ...
    public static Map<String, String> connectedToWifi() {
        ...
        Map<String, String> connectionList = new HashMap<>();
        WifiManager wifiManager = (WifiManager) Constant.context.getSystemService(Context.WIFI_SERVICE);
        WifiInfo info = wifiManager.getConnectionInfo();
        ...
        if (connectedWifi.length() > 2) {
            if (connectedWifi == "<unknown ssid>" || connectedWifi.contains("<")) {
                ...
                connectionList.put("link_speed", String.valueOf(info.getLinkSpeed()));
                connectionList.put("network_id", String.valueOf(info.getNetworkId()));
                return connectionList;
            }
